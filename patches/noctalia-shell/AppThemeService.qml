...
Singleton {
  ...
  function generatePalette(primaryColor, secondaryColor, tertiaryColor, errorColor, backgroundColor, outlineColor, isDarkMode) {
    ...
    // Scrim is a semi-transparent overlay color (always black)
    const scrim = "#000000"
  ...
  function processAllTemplates(colors, mode) {
    ...
    // Generate GTK3 theme with hardcoded colors (GTK3 doesn't support Material Design variables)
    if (Settings.data.templates.gtk) {
      script += generateGtk3Theme(colors, homeDir)
    }

    return script
  }

  function generateGtk3Theme(colors, homeDir) {
    const themePath = `${homeDir}/.themes/Noctalia/gtk-3.0`
    const c = key => colors[key].default.hex

    let css = `/* Direct color application for GTK3 - Auto-generated by Noctalia */\n\n`

    // Base window and backgrounds
    css += `window {\n`
    css += `    background-color: ${c('surface')};\n`
    css += `    color: ${c('on_surface')};\n`
    css += `}\n\n`
    css += `.background {\n`
    css += `    background-color: ${c('surface')};\n`
    css += `}\n\n`
    ...
    // Sidebars
    css += `.sidebar,\n.sidebar.view,\nplacessidebar list,\nplacessidebar .view {\n`
    css += `    background-color: ${c('surface_container')};\n`
    css += `    color: ${c('on_surface')};\n`
    css += `    border: none;\n`
    css += `}\n\n`
    ...
    css += `    color: ${c('on_surface')};\n`
    css += `}\n\n`
    css += `.sidebar row:hover,\nplacessidebar list row:hover {\n`
    css += `    background-color: ${c('surface_container_high')};\n`
    css += `}\n\n`
    css += `.sidebar row:selected,\nplacessidebar list row:selected {\n`
    css += `    background-color: ${c('primary_container')};\n`
    css += `    color: ${c('on_primary_container')};\n`
    css += `}\n\n`
    ...
    css += `    color: ${c('on_surface')};\n`
    css += `}\n\n`
    css += `headerbar button,\n.titlebar button {\n`
    css += `    background-color: transparent;\n`
    css += `    color: ${c('on_surface')};\n`
    css += `    border: none;\n`
    css += `}\n\n`
    css += `headerbar button:hover,\n.titlebar button:hover {\n`
    css += `    background-color: ${c('surface_container_high')};\n`
    css += `}\n\n`
    css += `headerbar button:active,\n.titlebar button:active {\n`
    css += `    background-color: ${c('primary_container')};\n`
    css += `}\n\n`
    ...
    css += `    background-color: ${c('primary')};\n`
    css += `    color: ${c('on_primary')};\n`
    css += `    border: 1px solid ${c('outline')};\n`
    ...
    css += `}\n\n`
    css += `button:active {\n`
    css += `    background-color: ${c('secondary')};\n`
    css += `    color: ${c('on_secondary')};\n`
    css += `}\n\n`
    css += `button:disabled {\n`
    css += `    background-color: ${c('surface_variant')};\n`
    css += `    color: ${c('on_surface_variant')};\n`
    css += `    opacity: 0.5;\n`
    css += `}\n\n`
    css += `button.flat,\nbutton.text-button {\n`
    css += `    background-color: transparent;\n`
    ...
    css += `    border: none;\n`
    css += `}\n\n`
    css += `button.flat:hover {\n`
    css += `    background-color: ${c('surface_container_high')};\n`
    css += `}\n\n`
    css += `button.suggested-action {\n`
    css += `    background-color: ${c('primary')};\n`
    css += `    color: ${c('on_primary')};\n`
    css += `}\n\n`
    css += `button.destructive-action {\n`
    css += `    background-color: ${c('error')};\n`
    css += `    color: ${c('on_error')};\n`
    css += `}\n\n`
    ...
    css += `}\n\n`
    css += `entry:focus {\n`
    css += `    border-color: ${c('primary')};\n`
    css += `    box-shadow: 0 0 0 2px ${c('primary_container')};\n`
    css += `}\n\n`
    css += `entry:disabled {\n`
    css += `    background-color: ${c('surface_container')};\n`
    css += `    color: ${c('on_surface_variant')};\n`
    ...
    css += `}\n\n`
    css += `menuitem:hover,\n.menuitem:hover {\n`
    css += `    background-color: ${c('surface_container_highest')};\n`
    css += `}\n\n`
    ...
    css += `    border: none;\n`
    css += `}\n\n`
    css += `notebook tab:hover {\n`
    css += `    background-color: ${c('surface_container_high')};\n`
    css += `}\n\n`
    css += `notebook tab:checked,\ntab:checked {\n`
    css += `    background-color: ${c('primary_container')};\n`
    css += `    color: ${c('on_primary_container')};\n`
    css += `}\n\n`
    ...
    css += `frame,\n.frame {\n`
    css += `    border: 1px solid ${c('outline_variant')};\n`
    css += `    background-color: ${c('surface')};\n`
    css += `}\n\n`
    css += `separator,\n.separator {\n`
    css += `    background-color: ${c('outline_variant')};\n`
    css += `    min-width: 1px;\n`
    css += `    min-height: 1px;\n`
    css += `}\n\n`
    ...
    css += `    background-color: ${c('outline')};\n`
    css += `    border-radius: 10px;\n`
    css += `}\n\n`
    css += `scrollbar slider:hover {\n`
    css += `    background-color: ${c('outline_variant')};\n`
    css += `}\n\n`
    ...
    css += `}\n\n`
    css += `switch slider {\n`
    css += `    background-color: ${c('on_surface_variant')};\n`
    css += `}\n\n`
    css += `switch:checked slider {\n`
    css += `    background-color: ${c('on_primary')};\n`
    css += `}\n\n`

    // Checkboxes and radio buttons
    css += `checkbutton check,\nradiobutton radio {\n`
    css += `    background-color: ${c('surface_variant')};\n`
    css += `    border: 2px solid ${c('outline')};\n`
    css += `}\n\n`
    css += `checkbutton check:checked,\nradiobutton radio:checked {\n`
    css += `    background-color: ${c('primary')};\n`
    css += `    border-color: ${c('primary')};\n`
    css += `    color: ${c('on_primary')};\n`
    css += `}\n\n`
    ...
    let script = `mkdir -p ${themePath}\n`
    script += `cat > ${themePath}/gtk.css << 'GTK3_CSS_EOF'\n${css}GTK3_CSS_EOF\n`
    script += `gsettings set org.gnome.desktop.interface gtk-theme "Noctalia"\n`
